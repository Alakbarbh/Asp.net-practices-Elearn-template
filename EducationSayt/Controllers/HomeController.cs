...
namespace EducationSayt.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            IEnumerable<Course> courses = await _context.Courses.Include(m => m.Author).Include(m=>m.CourseImages).Where(m => !m.SoftDelete).OrderByDescending(m=>m.Id).ToListAsync();
